<section id="home" class="relative min-h-screen flex items-center justify-center pt-20 px-6 lg:px-10 bg-[#0f0d0d] overflow-hidden">
    {{-- Background Image --}}
    ...
    <div class="relative z-10 w-full max-w-7xl flex flex-col lg:flex-row items-center gap-12 lg:gap-16 mt-10 lg:mt-0">
        {{-- Teks Bagian Kiri --}}
        <div class="flex-1 text-left flex flex-col">
            <div class="text-[#e8e6e1]/60 font-bold uppercase tracking-[0.3em] mb-4 text-xs">#1 GYM DI PIAI</div>
            <h1 class="text-[60px] lg:text-[100px] font-black uppercase tracking-tighter leading-[0.9] text-[#e8e6e1] mb-6">
                TEMPA <br> <span class="text-red-600">DIRIMU</span> <br> JADILAH <br> LEGENDA
            </h1>
            <div class="w-24 lg:w-80 h-1 bg-red-600 mb-8"></div>
            ...
            <div class="flex flex-wrap gap-4 mb-10">
                <a href="#cta-banner" class="px-8 py-4 bg-red-600 text-white font-black rounded-lg hover:bg-red-700 transition flex items-center gap-2">
                    GABUNG SEKARANG →
                </a>
                <a href="{{ asset('videos/promo.mp4') }}" target="_blank" 
                    class="px-8 py-4 border border-[#444] text-[#e8e6e1] font-black rounded-lg hover:bg-white/10 transition text-center">
                        ▶ LIHAT VIDEO
                    </a>
            </div>

            {{-- Footer Stats (Total Members) --}}
            <div class="flex gap-8 lg:gap-12 mt-auto">
                <div>
                    {{-- Menampilkan total member dari database --}}
                    <div class="text-2xl font-black text-[#e8e6e1]">{{ $totalMembers ?? 0 }}</div>
                    <div class="text-[10px] text-red-600 font-black uppercase tracking-widest">MEMBER</div>
                </div>
                <div>
                    <div class="text-2xl font-black text-[#e8e6e1]">98%</div>
                    <div class="text-[10px] text-red-600 font-black uppercase tracking-widest">PUAS</div>
                </div>
                <div>
                    <div class="text-2xl font-black text-[#e8e6e1]">5+</div>
                    <div class="text-[10px] text-red-600 font-black uppercase tracking-widest">TAHUN</div>
                </div>
            </div>
        </div>
